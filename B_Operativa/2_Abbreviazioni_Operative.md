...
```mermaid
graph LR;
    Telegrafo["Telegrafo<br>1850s<br>⚡"] --> Radiotelegrafo["Radiotelegrafo<br>1900s<br>📡"];
    Radiotelegrafo --> CW["CW/Morse<br>1910s<br>·-·"];
    CW --> SSB["SSB/Voce<br>1950s<br>🎙️"];
    SSB --> Digitale["Digitale<br>2000s<br>💻"];
    Digitale --> Futuro["Futuro<br>🤖"];
    classDef evoluzione fill:#0cf,stroke:#333,stroke-width:2px;
    class CW,SSB,Digitale evoluzione;
```
...
graph LR;
    ...
    Risposta --> Scambio["Scambio<br>RST QTH"];
    Scambio --> Chiusura["Chiusura<br>73 TU E E"];
    Chiusura --> Fine["Fine<br>AR"];
    classDef comunicazione fill:#0f0,stroke:#333,stroke-width:2px;
    class Risposta,Scambio comunicazione;
```
...
| **SNR** | Signal-to-Noise Ratio | dB (più alto meglio) |
...
## 📝 Uso Pratico delle Abbreviazioni
...
```mermaid
graph LR;
    MessaggioLungo["Messaggio Lungo<br>'Good morning, this is IK0AAA from Rome'"] --> TempoLungo["15 secondi<br>🎙️"];
    MessaggioCorto["Abbreviato<br>'GM IK0AAA ROME'"] --> TempoCorto["5 secondi<br>⚡"];
    TempoLungo --> Risparmio["Risparmio 70%<br>💰"];
    TempoCorto --> Risparmio;
    classDef efficiente fill:#0f0,stroke:#333,stroke-width:2px;
    class MessaggioCorto,TempoCorto efficiente;
```

## 🎓 Apprendimento delle Abbreviazioni
...
<details>
  ...
  <p><strong>B) Chiamata generale</strong></p>
  <p>CQ significa "Chiamata a tutte le stazioni" ed è usato per chiamare chiunque.</p>
</details>
...
<details>
  <summary>Risposta</summary>
  <p><strong>B) Segnale perfetto</strong></p>
  <p>RST 599 indica intelligibilità eccellente (5), forza massima (9), tono perfetto (9).</p>
</details>
...
<details>
  <summary>Risposta</summary>
  <p><strong>B) Per favore</strong></p>
  <p>PSE è l'abbreviazione di "Please" (per favore).</p>
</details>
...
<details>
  ...
  <p>73 significa "Best regards" (migliori auguri) e chiude amichevolmente il contatto.</p>
</details>
...
<details>
  <summary>Risposta</summary>
  <p><strong>C) Interruzione per emergenza</strong></p>
  <p>BK significa "Break" e permette di interrompere una trasmissione in corso per priorità.</p>
</details>
