...
```mermaid
graph TD;
    LineaSbilanciata["Linea Sbilanciata<br>Coassiale<br>50Ω"] --> Balun["Balun 1:1<br>Trasformatore"];
    Balun --> LineaBilanciata["Linea Bilanciata<br>Bifilare<br>50Ω"];
    LineaBilanciata --> Antenna["Antenna<br>Dipolo"];
    classDef bilanciamento fill:#0f0,stroke:#333,stroke-width:2px;
    class Balun bilanciamento;
```
...
### Diagramma Accordatore Pi
```mermaid
graph TD;
    Radio["Radio<br>50Ω"] --> L1["L1<br>Serie"];
    L1 --> C1["C1<br>Parallelo"];
    C1 --> L2["L2<br>Serie"];
    L2 --> Antenna["Antenna<br>Variabile"];
    classDef componente fill:#f90,stroke:#333,stroke-width:2px;
    class L1,C1,L2 componente;
```
