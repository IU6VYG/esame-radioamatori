...
![Filtro armoniche TX](pathname:///images/09_disturbi/filtro_armoniche_tx.svg)
...
![Filtro linea AC](pathname:///images/09_disturbi/filtro_linea_ac.svg)

*Filtro EMI con condensatori X (differenziale), Y (modo comune) e induttori accoppiati.*

![Filtro rete funzionale](pathname:///images/09_disturbi/filtro_rete_funzionale.png)
...
![Disaccoppiamento IC](pathname:///images/09_disturbi/disaccoppiamento_ic.svg)
...
![Ferrite su cavi](pathname:///images/09_disturbi/ferrite_cavo.png)
...
![Schermatura EMI](pathname:///images/09_disturbi/schermatura_emi.png)
