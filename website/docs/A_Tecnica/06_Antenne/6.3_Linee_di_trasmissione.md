---
sidebar_position: 3
title: "6.3 Linee di Trasmissione: Il Ponte tra Apparato e Antenna"
---
...
![Velocità di propagazione nei cavi](pathname:///images/06_antenne/velocita_propagazione.png)
...
![Onde stazionarie per diversi valori di SWR](pathname:///images/06_antenne/onde_stazionarie_swr.png)
...
![Impedenza lungo la linea di trasmissione](pathname:///images/06_antenne/impedenza_linea.png)
...
![Attenuazione cavi coassiali](pathname:///images/06_antenne/attenuazione_cavi.png)
...
![Carta di Smith](pathname:///images/06_antenne/carta_smith.png)
...
|----------------|--------|-----|
| Passa-basso (L serie + C parallelo) | ![L-match LP](pathname:///images/06_antenne/rete_l_match_lowpass.svg) | Z alta → Z bassa |
| Passa-alto (C serie + L parallelo) | ![L-match HP](pathname:///images/06_antenne/rete_l_match_highpass.svg) | Z bassa → Z alta |

#### Rete Pi-Match (π)

Configurazione C-L-C, molto usata negli accordatori manuali.

![Pi-match](pathname:///images/06_antenne/rete_pi_match.svg)
...
![T-match](pathname:///images/06_antenne/rete_t_match.svg)

*Accordatore T: due induttori e un condensatore centrale.*

#### Accordatore Completo

![Accordatore T completo](pathname:///images/06_antenne/accordatore_t_completo.svg)
