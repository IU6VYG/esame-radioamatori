...
graph TD;
    ...
    BraccioSx --> TensioneMax["Tensione Max<br>Estremità"];
    BraccioDx --> TensioneMax2["Tensione Max<br>Estremità"];
    Alimentazione --> CorrenteMax["Corrente Max<br>Centro"];
...
- **Guadagno**: Identico al dipolo semplice (2.15 dBi)
