...
### Potenza in Modulazione AM

- **Potenza media**: $P_{media} = P_c \times \left(1 + \frac{m^2}{2}\right)$
- **Potenza PEP** (Peak Envelope Power): $P_{PEP} = P_c \times (1 + m)^2$

dove $P_c$ è la potenza della portante e $m$ è l'indice di modulazione (0 ≤ m ≤ 1).
...
<details>
  ...
  <p><strong>A) 2x potenza</strong></p>
  <p>3 dB = 10 log(2) ≈ 10 × 0.301 = 3.01 dB. Un aumento di 3 dB corrisponde al raddoppio della potenza. In tensione, 3 dB corrisponde a ×√2 ≈ 1.414, ma la risposta più significativa è il raddoppio di potenza.</p>
</details>
