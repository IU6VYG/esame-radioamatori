---
sidebar_position: 2
title: "8.2 Strumenti di Misura: Gli Strumenti del Radioamatore"
---
...
![Schema multimetro](pathname:///images/08_misure/schema_multimetro.png)
...
![Schema ROSmetro](pathname:///images/08_misure/schema_rosmetro.png)
...
![Schema wattmetro](pathname:///images/08_misure/schema_wattmetro.png)
...
![Schema oscilloscopio](pathname:///images/08_misure/schema_oscilloscopio.png)
...
![Schema analizzatore spettro](pathname:///images/08_misure/schema_analizzatore_spettro.png)
...
![Setup misura potenza](pathname:///images/08_misure/setup_misura_potenza.png)
...
![Setup misura ROS](pathname:///images/08_misure/setup_misura_ros.png)
...
![Setup test due toni](pathname:///images/08_misure/setup_test_due_toni.png)
...
![Posizionamento sonde](pathname:///images/08_misure/setup_sonde_oscilloscopio.png)
