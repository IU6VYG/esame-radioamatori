---
sidebar_position: 7
title: "3.7 Circuiti ad Aggancio di Fase (PLL)"
---
...
### PLL Base
![PLL Base](pathname:///images/03_circuiti/pll_base.svg)
...
### Phase Detector PLL
![Phase Detector PLL](pathname:///images/03_circuiti/phase_detector_pll.svg)
...
### Loop Filter per PLL
![Loop Filter per PLL](pathname:///images/03_circuiti/loop_filter_pll.svg)
...
### VCO per PLL
![VCO per PLL](pathname:///images/03_circuiti/vco_pll.svg)
...
![Sintetizzatore con PLL](pathname:///images/03_circuiti/sintetizzatore_pll.svg)
...
![Clock Generator con PLL](pathname:///images/03_circuiti/clock_generator_pll.svg)
...
<details>
  ...
  <p>f_out = N × f_ref = 100 × 10MHz = 1GHz</p>
</details>
...
<details>
  <summary>Risposta</summary>
  <p><strong>A) Risposta più rapida</strong></p>
  <p>Bandwidth più larga = risposta più veloce ma stabilità ridotta.</p>
</details>
...
<details>
  ...
  <p>I PLL digitali sono più economici e compatti.</p>
</details>
...
<details>
  ...
  <p>t_lock ≈ 1/(2π × BW), quindi BW più grande = lock time più piccolo.</p>
</details>
