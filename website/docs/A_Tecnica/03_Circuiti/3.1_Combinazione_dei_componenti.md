...
![Partitore di Tensione](pathname:///images/03_circuiti/circuito_partitore_tensione.svg)

**V_out = V_in × (R₂/(R₁ + R₂))**

### Circuito con Trasformatore Accoppiato
![Circuito con Trasformatore](pathname:///images/03_circuiti/circuito_trasformatore_accoppiamento.svg)
...
### Circuito Serie RL
![Circuito Serie RL](pathname:///images/03_circuiti/circuito_serie_rl.svg)
...
### Serie RLC
![Circuito Serie RLC](pathname:///images/03_circuiti/circuito_serie_rlc.svg)

**Impedenza totale**: Z = R + j(ωL - 1/(ωC))

### RLC Parallelo
![Circuito RLC Parallelo](pathname:///images/03_circuiti/circuito_rlc_parallelo.svg)
...
### Ponte di Wheatstone
![Ponte di Wheatstone](pathname:///images/03_circuiti/circuito_ponte_wheatstone.svg)
...
![Circuito Complesso](pathname:///images/03_circuiti/circuito_impedenza_complesso.svg)
