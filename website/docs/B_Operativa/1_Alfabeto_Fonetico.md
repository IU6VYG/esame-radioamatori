...
```mermaid
graph LR;
    WWI["Militare<br>1914-18<br>🎖️"] --> UIT1927["UIT<br>1927<br>🌍"];
    UIT1927 --> UIT1932["UIT Revisione<br>1932<br>📝"];
    UIT1932 --> NATO1956["NATO/ICAO<br>1956<br>✈️"];
    NATO1956 --> Oggi["Standard Attuale<br>Oggi<br>📻"];
    classDef evoluzione fill:#0cf,stroke:#333,stroke-width:2px;
    class NATO1956,Oggi evoluzione;
```
...
```mermaid
graph TD;
    Alfabeto["Alfabeto Fonetico<br>NATO/ICAO<br>🔤"] --> Gruppo1["A-F<br>Alfa Bravo Charlie<br>Delta Echo Foxtrot"];
    Alfabeto --> Gruppo2["G-L<br>Golf Hotel India<br>Juliet Kilo Lima"];
    Alfabeto --> Gruppo3["M-R<br>Mike November Oscar<br>Papa Quebec Romeo"];
    Alfabeto --> Gruppo4["S-Z<br>Sierra Tango Uniform<br>Victor Whiskey X-Ray<br>Yankee Zulu"];
    classDef gruppo fill:#0cf,stroke:#333,stroke-width:2px;
    class Gruppo1,Gruppo2,Gruppo3,Gruppo4 gruppo;
```
...
```mermaid
graph TD;
    Chiamata["CQ CQ CQ<br>DE<br>India Uniform Six<br>Victor Yankee Golf"] --> Risposta["India Uniform Six<br>Victor Yankee Golf<br>DE<br>India Kilo Zero<br>Alfa Alfa Alfa"];
    Risposta --> Scambio["RST 59<br>QTH Romeo Oscar<br>Mike Alfa"];
    Scambio --> Conferma["QSL<br>73<br>India Kilo Zero<br>Alfa Alfa Alfa"];
    classDef qso fill:#0f0,stroke:#333,stroke-width:2px;
    class Chiamata,Risposta qso;
```
