...
```mermaid
graph LR;
    Telegrafo["Telegrafo<br>1850s<br>📝"] --> CodiceMorse["Codice Morse<br>1830s<br>⚡"];
    CodiceMorse --> Conferenza1909["Conferenza Londra<br>1909<br>🌍"];
    Conferenza1909 --> CodiceQ["Codice Q<br>1912<br>💬"];
    CodiceQ --> Radioamatori["Radioamatori<br>Oggi<br>📻"];
    classDef evoluzione fill:#0cf,stroke:#333,stroke-width:2px;
    class CodiceQ evoluzione;
```
...
```mermaid
graph TD;
    Qualita["Qualità Segnale<br>📊"] --> QRK["QRK<br>Intelligibilità<br>1-5"];
    Qualita --> QSA["QSA<br>Forza<br>1-5"];
    Qualita --> QSB["QSB<br>Variazione<br>Sì/No"];
    Interferenze["Interferenze<br>📢"] --> QRM["QRM<br>Uomo<br>🤖"];
    Interferenze --> QRN["QRN<br>Natura<br>⛈️"];
    Interferenze --> QRP["QRP<br>Riduci<br>🔽"];
    Interferenze --> QRO["QRO<br>Aumenta<br>🔼"];
    classDef qualita fill:#0f0,stroke:#333,stroke-width:2px;
    class QRK,QSA qualita;
    classDef interferenza fill:#f00,stroke:#333,stroke-width:2px;
    class QRM,QRN interferenza;
```
...
```mermaid
graph LR;
    Chiamata["Chiamata<br>CQ DE IK0AAA"] --> Risposta["Risposta<br>IK0AAA DE I1BBB"];
    Risposta --> ControlloQualita["Controllo Qualità<br>QRK? QSA?"];
    ControlloQualita --> Rapporto["Rapporto<br>QRK 5 QSA 5"];
    Rapporto --> ScambioInfo["Scambio Info<br>QTH? QSL?"];
    ScambioInfo --> CambioFreq["Cambio Frequenza<br>QSY 14.250"];
    CambioFreq --> Chiusura["Chiusura<br>QRT QRX"];
    classDef comunicazione fill:#0cf,stroke:#333,stroke-width:2px;
    class Risposta,ControlloQualita,Rapporto comunicazione;
```
...
<details>
  ...
  <p><strong>B) Intelligibilità del segnale</strong></p>
  <p>QRK misura quanto chiaramente si sente il segnale, su scala 1-5.</p>
</details>
...
<details>
  <summary>Risposta</summary>
  <p><strong>B) QRM è artificiale, QRN è naturale</strong></p>
  <p>QRM indica interferenze da altre trasmissioni, QRN da rumori atmosferici.</p>
</details>
...
<details>
  <summary>Risposta</summary>
  <p><strong>B) Cambiare frequenza</strong></p>
  <p>QSY indica il cambio di frequenza di trasmissione.</p>
</details>
...
<details>
  <summary>Risposta</summary>
  <p><strong>B) QSL</strong></p>
  <p>QSL significa "Do conferma di ricezione" e dà origine alle QSL card.</p>
</details>
...
<details>
  <summary>Risposta</summary>
  <p><strong>B) Segnale variabile</strong></p>
  <p>QSB indica che la forza del segnale varia nel tempo.</p>
</details>
