...
### Ponte Raddrizzatore
![Ponte Raddrizzatore](../images/circuito_ponte_raddrizzatore.svg)
...
![Alimentatore Lineare Completo](../images/alimentatore_lineare_completo.svg)
...
### Circuito con Filtro
![Circuito Raddrizzatore con Filtro](../images/circuito_raddrizzatore_filtro.svg)

### Raddrizzatore a Semionda con Filtro
![Raddrizzatore Semionda con Filtro](../images/raddrizzatore_semionda_filtro.svg)
...
![Stabilizzatore Zener](../images/circuito_stabilizzatore_zener.svg)

**V_out = V_zener** (se I_z > I_zk)

### Regolatore Lineare Serie
![Regolatore Lineare Serie](../images/regolatore_lineare_serie.svg)
...
![Protezione Sovratensione](../images/protezione_sovratensione.svg)

### Limitatore di Corrente
![Limitatore di Corrente](../images/limitatore_corrente.svg)
...
![Caricabatterie Li-ion](../images/caricabatterie_liion.svg)

### Caricabatterie CC-CV
![Caricabatterie CC-CV](../images/caricabatterie_cc_cv.svg)
...
![Convertitore Buck](../images/convertitore_buck.svg)

### Convertitore Boost (Step-Up)
![Convertitore Boost](../images/convertitore_boost.svg)
