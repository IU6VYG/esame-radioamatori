...
![Partitore di Tensione](../images/circuito_partitore_tensione.svg)

**V_out = V_in × (R₂/(R₁ + R₂))**

### Circuito con Trasformatore Accoppiato
![Circuito con Trasformatore](../images/circuito_trasformatore_accoppiamento.svg)
...
### Circuito Serie RC
![Circuito Serie RC](../images/circuito_serie_rc.svg)
...
### Circuito Serie RL
![Circuito Serie RL](../images/circuito_serie_rl.svg)
...
### Serie RLC
![Circuito Serie RLC](../images/circuito_serie_rlc.svg)

**Impedenza totale**: Z = R + j(ωL - 1/(ωC))

### RLC Parallelo
![Circuito RLC Parallelo](../images/circuito_rlc_parallelo.svg)
...
![Circuito di Protezione](../images/circuito_protezione_diodo.svg)

### Ponte di Wheatstone
![Ponte di Wheatstone](../images/circuito_ponte_wheatstone.svg)
...
![Circuito Complesso](../images/circuito_impedenza_complesso.svg)
