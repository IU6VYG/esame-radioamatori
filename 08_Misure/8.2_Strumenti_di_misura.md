...
```mermaid
graph TD;
    Generatore["Generatore<br>RF"] --> Ponte["Ponte<br>RF"];
    Ponte --> Riferimento["Impedenza<br>Riferimento<br>50Ω"];
    Ponte --> Sconosciuta["Impedenza<br>Sconosciuta"];
    Ponte --> Rivelatore["Rivelatore<br>Differenza"];
    Rivelatore --> Indicatore["Indicatore<br>Bilanciamento"];
    classDef ponte fill:#0cf,stroke:#333,stroke-width:2px;
    class Ponte ponte;
```
...
```mermaid
graph TD;
    SegnaleRF["Segnale<br>RF"] --> Assorbitore["Assorbitore<br>Termico"];
    Assorbitore --> Sensore["Sensore<br>Temperatura"];
    Sensore --> Amplificatore["Amplificatore"];
    Amplificatore --> Display["Display<br>Potenza"];
    Calibrazione["Calibrazione<br>Riferimento"] --> Amplificatore;
    classDef termico fill:#0cf,stroke:#333,stroke-width:2px;
    class Assorbitore,Sensore termico;
```
...
### Diagramma Oscilloscopio
```mermaid
graph TD;
    Segnale["Segnale<br>Elettrico"] --> Ingresso["Ingresso<br>Verticale"];
    Ingresso --> Amplificatore["Amplificatore<br>Verticale"];
    Amplificatore --> Schermo["Schermo<br>CRT/LCD"];
    BaseTempi["Base<br>Tempi"] --> Schermo;
    Trigger["Trigger<br>Circuito"] --> BaseTempi;
    classDef visuale fill:#f90,stroke:#333,stroke-width:2px;
    class Schermo visuale;
```
