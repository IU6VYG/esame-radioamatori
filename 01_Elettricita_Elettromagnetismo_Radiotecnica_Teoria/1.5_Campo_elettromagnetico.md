...
<table>
<tr>
<td width="70%">Il campo elettrico oscilla in un piano fisso.<br><strong>Sottotipi</strong>:<br>- Verticale: E ↑↓<br>- Orizzontale: E ←→<br><strong>Applicazioni</strong>:<br>- TV analogica terrestre (verticale)<br>- Radio FM/AM (orizzontale)<br>- VHF/UHF terrestri</td>
<td width="30%"><img src="../images/grafico_polarizzazione_lineare.png" width="100%"></td>
</tr>
</table>
...
<table>
<tr>
<td width="70%">Il campo elettrico ruota descrivendo un cerchio.<br><strong>Sottotipi</strong>:<br>- Destra: Rotazione oraria<br>- Sinistra: Rotazione antioraria<br><strong>Applicazioni</strong>:<br>- Satelliti GPS e comunicazione<br>- Wi-Fi e 5G</td>
<td width="30%"><img src="../images/grafico_polarizzazione_circolare.png" width="100%"></td>
</tr>
</table>
...
<table>
<tr>
<td width="70%">Combinazione di lineare e circolare, forma un'ellisse.<br><strong>Applicazioni</strong>:<br>- Radar meteorologico<br>- Sistemi dove la polarizzazione varia</td>
<td width="30%"><img src="../images/grafico_polarizzazione_ellittica.png" width="100%"></td>
</tr>
</table>
