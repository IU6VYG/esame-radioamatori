# 1.1 Conduttività (o Conducibilità): Il Flusso dell'Elettricità 🚀
...
- **Conduttori** (es. argento, rame, oro, alluminio): Ottimi per far passare la corrente. Sono come autostrade!
- **Semiconduttori** (es. silicio, germanio): Né troppo né poco conduttivi. Usati nei chip dei computer.
- **Isolanti** (es. plastica, gomma, vetro): Bloccano la corrente. Sono come muri.
...
La legge fondamentale! **V = R × I**

- Se aumenti la tensione, aumenta la corrente (se la resistenza è costante).
- Se aumenti la resistenza, diminuisce la corrente (se la tensione è costante).
